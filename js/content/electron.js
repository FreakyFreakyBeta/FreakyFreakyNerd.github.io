...
function setupquarkspinproducers() {
  ...
  player.electronstage.quarkspinproducers.push(new Producer("qs2", "Red Quark", [new ExponentialCost(player.electronstage.electrons, "10", 3)], [new LinearProduction(player.electronstage.quarkspinproducers[0], "1")], new NumRequirement(player.electronstage.quarkspinproducers[0], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs3", "Blue Quark", [new ExponentialCost(player.electronstage.electrons, "1e3", 4)], [new LinearProduction(player.electronstage.quarkspinproducers[1], "1")], new NumRequirement(player.electronstage.quarkspinproducers[1], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs4", "Antigreen Quark", [new ExponentialCost(player.electronstage.electrons, "1e6", 4)], [new LinearProduction(player.electronstage.quarkspinproducers[2], "1")], new NumRequirement(player.electronstage.quarkspinproducers[2], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs5", "Antired Quark", [new ExponentialCost(player.electronstage.electrons, "1e12", 4)], [new LinearProduction(player.electronstage.quarkspinproducers[3], "1")], new NumRequirement(player.electronstage.quarkspinproducers[3], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs6", "Antiblue Quark", [new ExponentialCost(player.electronstage.electrons, "1e24", 10)], [new LinearProduction(player.electronstage.quarkspinproducers[4], "1")], new NumRequirement(player.electronstage.quarkspinproducers[4], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs7", "Meson Quark", [new ExponentialCost(player.electronstage.electrons, "1e48", 100)], [new LinearProduction(player.electronstage.quarkspinproducers[5], "1e-6")], new NumRequirement(player.electronstage.quarkspinproducers[5], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs8", "Baryon Quark", [new ExponentialCost(player.electronstage.electrons, "1e96", 1000)], [new LinearProduction(player.electronstage.quarkspinproducers[6], "1e-10")], new NumRequirement(player.electronstage.quarkspinproducers[6], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs9", "Antibaryon Quark", [new ExponentialCost(player.electronstage.electrons, "1e200", 10000)], [new LinearProduction(player.electronstage.quarkspinproducers[7], "1e-20")], new NumRequirement(player.electronstage.quarkspinproducers[7], 10), "qsp", new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinproducers.push(new Producer("qs10", "Metaphysical Quark", [new ExponentialCost(player.electronstage.electrons, "1e500", 100000)], [new LinearProduction(player.electronstage.quarkspinproducers[8], "1e-100")], new NumRequirement(player.electronstage.quarkspinproducers[8], 10), "qsp", new AchievementRequirement("infinityquarks")));
}
...
function setupbasicelectronupgrades() {
  ...
  var chargemultpow = () => { if (totalproducerbought(player.quarkstage.producers).equals(1)) return .2; else return .1; }
...
function setupbasicelectronupgradesstage2() {
  ...
  player.electronstage.upgrades.push(new Upgrade("eu29", "[eu30] Acceleration Time", 500, new AchievementRequirement("1nucleonize"), new ExponentialEffect(player.quarkstage.upgrades[2], 1, 1.25, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Accelerator Power *" + formatDecimal(obj.value) + "(*" + formatDecimal(obj.increase) + ")"), new ExponentialCost(player.electronstage.electrons, "1e1600", "1e10"), "upg"));
...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("2s", "Orbital 2S", new LinearEffect(player.quarkstage.electrify, 1, .01, EffectTypes.PrestigeExponentialGain, null, (obj) => "Electron gain ^" + formatDecimalOverride(obj.value, 2) + " (+ " + formatDecimalOverride(obj.increase, 2) + ") "), new ExponentialCost(null, "1e3", "1e3"), player.electronstage.clouds.power, new NumRequirement(player.electronstage.electrons, "1e30")));
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3s", "Orbital 3S", new LinearEffect(player.electronstage.quarkspinproducers, 1, 1, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimalOverride(obj.value, 0) + " (+ " + formatDecimalOverride(obj.increase, 0) + ") "), new ExponentialCost(null, "500", "2"), player.electronstage.clouds.power, new NumRequirement(player.electronstage.quarkspin, "1e100")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3p", "Orbital 3P", new LinearEffect(player.electronstage.clouds.power, 1, 1, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Electron Power Amount *" + formatDecimalOverride(obj.value, 0) + "(+" + formatDecimalOverride(obj.increase, 0) + ")"), new ExponentialCost(null, "1e3", "1e3"), player.electronstage.clouds.power, new NumRequirement(player.electronstage.clouds.power, "10")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4s", "Orbital 4S", new LinearEffect(player.quarkstage.upgrades[5], 1, .005, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Multor Power *" + formatDecimalOverride(obj.value, 2) + "(+" + formatDecimalOverride(obj.increase, 2) + ")"), new ExponentialCost(null, "1e2", "1e4"), player.electronstage.clouds.power, new AchievementRequirement("500acceleron")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3d", "Orbital 3D", new LinearEffect(player.quarkstage.upgrades[5], 0, 5, EffectTypes.UpgradeBonusLevels, null, (obj) => "Free Multors " + formatDecimalOverride(obj.value, 0) + "(+" + formatDecimalOverride(obj.increase, 0) + ")"), new ExponentialCost(null, "1e4", "1e2"), player.electronstage.clouds.power, new AchievementRequirement("500acceleron")));
