...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("1s", "Orbital 1S", new ExponentialEffect(player.quarkstage.producers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimalNormal(obj.value) + "(*" + formatDecimal(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "10", "2.5"), new HyperExponentialCost(null, "1e6", "2.5", "2")], ["10"]), player.electronstage.clouds.power));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("2s", "Orbital 2S", new ExponentialEffect(player.quarkstage.electrify, 1, 1.005, EffectTypes.PrestigeExponentialGain, null, (obj) => "Electron gain ^" + formatDecimalOverride(obj.value, 3) + " (*" + formatDecimalOverride(obj.increase, 3) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "5"),new HyperExponentialCost(null, "1e7", "5", "2")], ["0","5"]), player.electronstage.clouds.power, new NumRequirement(player.electronstage.electrons, "1e18")));
