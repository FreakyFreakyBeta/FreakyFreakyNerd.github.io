...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("1s", "Orbital 1S", new ExponentialEffect(player.quarkstage.producers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimalNormal(obj.value) + "(*" + formatDecimalNormal(obj.increase) + ")"), new ExponentialCost(null, "10", "2.5"), player.electronstage.clouds.power));
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3s", "Orbital 3S", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimalNormal(obj.value) + " (*" + formatDecimalNormal(obj.increase) + ")"), new ExponentialCost(null, "500", "2.5"), player.electronstage.clouds.power, new NumRequirement(player.electronstage.quarkspinproducers[4], "10")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3p", "Orbital 3P", new ExponentialEffect(player.electronstage.clouds.power, 1, 1.5, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Electron Power Amount *" + formatDecimalOverride(obj.value, 1) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new ExponentialCost(null, "1e2", "10"), player.electronstage.clouds.power, new TotalNumRequirement(player.electronstage.clouds.power, "10")));
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3d", "Orbital 3D", new LinearEffect(player.quarkstage.upgrades[5], 0, 5, EffectTypes.UpgradeBonusLevels, null, (obj) => "Free Multors " + formatDecimalOverride(obj.value, 0) + "(+" + formatDecimalOverride(obj.increase, 0) + ")"), new ExponentialCost(null, "1e3", "2.5"), player.electronstage.clouds.power, new NumRequirement(getupgrade("qu9"), "25")));
