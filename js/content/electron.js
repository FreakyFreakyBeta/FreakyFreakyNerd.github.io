...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3s", "Orbital 3S", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimalNormal(obj.value) + " (*" + formatDecimal(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "500", "2.5"), new HyperExponentialCost(null, "1e28", "2.5", "2")], ["40"]), player.electronstage.clouds.power, new NumRequirement(player.electronstage.quarkspinproducers[4], "10")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3p", "Orbital 3P", new ExponentialEffect(player.electronstage.clouds.power, 1, 1.5, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Electron Power Amount *" + formatDecimalOverride(obj.value, 1) + "(*" + formatDecimal(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e2", "10"), new HyperExponentialCost(null, "1e14", "10", "2")], ["20"]), player.electronstage.clouds.power, new TotalNumRequirement(player.electronstage.clouds.power, "10")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4s", "Orbital 4S", new ExponentialEffect(player.quarkstage.upgrades[5], 1, 1.01, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Multor Power *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e2", "5"),new HyperExponentialCost(null, "1e24", "5", "2")], ["20"]), player.electronstage.clouds.power, new NumRequirement(getupgrade("qu5"), "80")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3d", "Orbital 3D", new LinearEffect(player.quarkstage.upgrades[5], 0, 5, EffectTypes.UpgradeBonusLevels, null, (obj) => "Free Multors " + formatDecimal(obj.value, 0) + "(+" + formatDecimal(obj.increase, 0) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "2.5"), new HyperExponentialCost(null, "1e12", "2.5", "2")], ["10"]), player.electronstage.clouds.power, new NumRequirement(getupgrade("qu9"), "25")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4p", "Orbital 4P", new ExponentialEffect(player.quarkstage.producers, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Producer Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e28", "1e1", "2")], ["20"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5s", "Orbital 5S", new ExponentialEffect(player.quarkstage.upgrades, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Producers Upgrades Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e28", "1e1", "2")], ["20"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4d", "Orbital 4D", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Spin Producers Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e28", "1e1", "2")], ["20"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5p", "Orbital 5P", new ExponentialEffect(player.electronstage.quarkspinupgrades, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Spin Upgrades Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e28", "1e1", "2")], ["20"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6s", "Orbital 6S", new ExponentialEffect(player.quarkstage.upgrades, 1, 1.01, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Quark Producers Upgrades Effective Amount *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e28", "1e1", "2")], ["20"]), player.electronstage.clouds.power, new NumRequirement(getcurrency("electron"), "1e20")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4f", "Orbital 4F", new ExponentialEffect(player.challenges, 1, 1.5, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e34", "10", "2")], ["20"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("7p", "Orbital 7P", new ExponentialEffect(player.electronstage.nucleonize, 1, 1.5, EffectTypes.PrestigeMultiplicativeGain, null, (obj) => "Nucleon Gain *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e12", "1e6"), new HyperExponentialCost(null, "1e96", "1e6", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
}
