...
function setupbasicelectronupgrades() {
  ...
  player.electronstage.upgrades.push(new Upgrade("eu1", "Get 10 free Acelerons.", 1, null, [new StaticEffect(player.quarkstage.upgrades[0], 10, EffectTypes.UpgradeBonusLevels, null, () => "Helps especially at the beginning of a run")], [new StaticCost(player.electronstage.electrons, 10)], "upg", {tag : "e"}))
...
function setupbasicelectronupgradesstage2() {
  ...
  player.electronstage.upgrades.push(new Upgrade("eu15", "I need dem quarks", 100, new AchievementRequirement("1nucleonize"), new ExponentialEffect(player.quarkstage.producers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimal(obj.value) + "(*" + formatDecimal(obj.increase) + ")"), new ExponentialCost(player.electronstage.electrons, "1e130", "10"), "upg", {tag : "e"}));
  player.electronstage.upgrades.push(new Upgrade("eu16", "I need the spin", 100, new AchievementRequirement("1nucleonize"), new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimal(obj.value) + "(*" + formatDecimal(obj.increase) + ")"), new ExponentialCost(player.electronstage.electrons, "1e140", "10"), "upg", {tag : "e"}));
  ...
  player.electronstage.upgrades.push(new Upgrade("eu18", "Quarks!!", 1, new AchievementRequirement("1nucleonize"), new StaticEffect(player.quarkstage.producers, 1.1, EffectTypes.ProducerExponentialProduction, null, (obj) => "Quark Production ^" + formatDecimal(obj.value)), new StaticCost(player.electronstage.electrons, "1e300"), "upg", {tag: "e"}));
  ...
  player.electronstage.upgrades.push(new Upgrade("eu20", "Electrons!!", 1, new AchievementRequirement("1nucleonize"), new StaticEffect(player.quarkstage.electrify, 1.1, EffectTypes.PrestigeExponentialGain, null, (obj) => "Electron Gain ^" + formatDecimal(obj.value)), new StaticCost(player.electronstage.electrons, "1e500"), "upg", {tag: "e"}));
...
function setupbasicquarkspinupgrades() {
  ...
  player.electronstage.quarkspinupgrades.push(new DiminishingUpgrade("su1", "Respinner", -1, null, [new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 1.1, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Respinner Power *" + formatDecimalOverride(obj.increase, 1) + " | Quark Spin Producers *" + formatDecimalOverride(obj.value, 2))], new ExponentialCost(player.electronstage.quarkspin, "1e3", 5), "qsp", 1000, (num) => Decimal.pow(num, .1), new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinupgrades.push(new DiminishingUpgrade("su2", "Aceleron Plus", -1, null, [new LinearEffect(player.quarkstage.upgrades[0], 1, .5, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Acceleron Power +" + formatDecimalOverride(obj.increase, 1) + " | Acceleron power *" + formatDecimalOverride(obj.value, 1))], new ExponentialCost(player.electronstage.quarkspin, "1e6", 10), "qsp", 1000, (num) => Decimal.pow(num, .1), new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinupgrades.push(new DiminishingUpgrade("su3", "Multor Plus", -1, null, [new LinearEffect(player.quarkstage.upgrades[5], 1, .001, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Multor Power +" + formatDecimalOverride(obj.increase, 3) + " | Multor power *" + formatDecimalOverride(obj.value, 3))], new ExponentialCost(player.electronstage.quarkspin, "1e8", 10), "qsp", 100, (num) => Decimal.pow(num, .1), new AchievementRequirement("infinityquarks")));
  player.electronstage.quarkspinupgrades.push(new DiminishingUpgrade("su4", "Better Challenges", -1, null, [new ExponentialEffect([player.challenges[0], player.challenges[1], player.challenges[2], player.challenges[3]], 1, 1.1, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge 1-4 Score *" + formatDecimalOverride(obj.value, 2))], new ExponentialCost(player.electronstage.quarkspin, "1e12", "100"), "qsp", 1000, (num) => Decimal.pow(num, .1), new AchievementRequirement("infinityquarks")));
}
...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("1s", "Orbital 1S", new ExponentialEffect(player.quarkstage.producers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimalNormal(obj.value) + "(*" + formatDecimal(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "10", "2.5"), new HyperExponentialCost(null, "1e24", "2.5", "2")], ["40"]), player.electronstage.clouds.power));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("2s", "Orbital 2S", new ExponentialEffect(player.quarkstage.electrify, 1, 1.005, EffectTypes.PrestigeExponentialGain, null, (obj) => "Electron gain ^" + formatDecimalOverride(obj.value, 3) + " (*" + formatDecimalOverride(obj.increase, 3) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "5"),new HyperExponentialCost(null, "1e28", "5", "2")], ["20"]), player.electronstage.clouds.power, new NumRequirement(player.electronstage.electrons, "1e18")));
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3s", "Orbital 3S", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimalNormal(obj.value) + " (*" + formatDecimal(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "500", "2.5"), new HyperExponentialCost(null, "1e7", "2.5", "2")], ["10"]), player.electronstage.clouds.power, new NumRequirement(player.electronstage.quarkspinproducers[4], "10")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3p", "Orbital 3P", new ExponentialEffect(player.electronstage.clouds.power, 1, 1.5, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Electron Power Amount *" + formatDecimalOverride(obj.value, 1) + "(*" + formatDecimal(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e2", "10"), new HyperExponentialCost(null, "1e12", "10", "2")], ["10"]), player.electronstage.clouds.power, new TotalNumRequirement(player.electronstage.clouds.power, "10")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4s", "Orbital 4S", new ExponentialEffect(player.quarkstage.upgrades[5], 1, 1.01, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Multor Power *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e2", "5"),new HyperExponentialCost(null, "1e6", "5", "2")], ["5"]), player.electronstage.clouds.power, new NumRequirement(getupgrade("qu5"), "80")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3d", "Orbital 3D", new LinearEffect(player.quarkstage.upgrades[5], 0, 5, EffectTypes.UpgradeBonusLevels, null, (obj) => "Free Multors " + formatDecimal(obj.value, 0) + "(+" + formatDecimal(obj.increase, 0) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "2.5"), new HyperExponentialCost(null, "1e6", "2.5", "2")], ["5"]), player.electronstage.clouds.power, new NumRequirement(getupgrade("qu9"), "25")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4p", "Orbital 4P", new ExponentialEffect(player.quarkstage.producers, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Producer Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5s", "Orbital 5S", new ExponentialEffect(player.quarkstage.upgrades, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Producers Upgrades Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4d", "Orbital 4D", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Spin Producers Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5p", "Orbital 5P", new ExponentialEffect(player.electronstage.quarkspinupgrades, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Spin Upgrades Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1000boosts")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6s", "Orbital 6S", new ExponentialEffect(player.quarkstage.upgrades, 1, 1.01, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Quark Producers Upgrades Effective Amount *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new NumRequirement(getcurrency("electron"), "1e20")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4f", "Orbital 4F", new ExponentialEffect(player.challenges, 1, 1.5, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e17", "10", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5d", "Orbital 5D", new ExponentialEffect(player.electronstage.clouds.power, 1, 1.1, EffectTypes.ChallengeScoreMult, null, (obj) => "Electron Power Amount *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e17", "10", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6p", "Orbital 6P", new ExponentialEffect(player.quarkstage.producers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimalNormal(obj.value) + "(*" + formatDecimalNormal(obj.increase) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e17", "10", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("7s", "Orbital 7S", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 1.1, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e17", "10", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5f", "Orbital 5F", new ExponentialEffect(player.quarkstage.electrify, 1, 1.1, EffectTypes.PrestigeMultiplicativeGain, null, (obj) => "Electron Gain *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e17", "10", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6d", "Orbital 6D", new ExponentialEffect(player.quarkstage.upgrades[0], 1, 2, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Acceleron Power *" + formatDecimalNormal(obj.value) + "(*" + formatDecimalNormal(obj.increase) + ")"), new CombinedCost([new ExponentialCost(null, "1e6", "10"),new HyperExponentialCost(null, "1e17", "10", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("7p", "Orbital 7P", new ExponentialEffect(player.electronstage.nucleonize, 1, 1.5, EffectTypes.PrestigeMultiplicativeGain, null, (obj) => "Nucleon Gain *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e12", "1e6"), new HyperExponentialCost(null, "1e48", "1e6", "2")], ["5"]), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
