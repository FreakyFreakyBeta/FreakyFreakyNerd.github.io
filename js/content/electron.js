...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4f", "Orbital 4F", new ExponentialEffect(player.challenges, 1, 1.5, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new ExponentialCost(null, "1e6", "10"), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5d", "Orbital 5D", new ExponentialEffect(player.electronstage.clouds.power, 1, 1.1, EffectTypes.ChallengeScoreMult, null, (obj) => "Electron Power Amount *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new ExponentialCost(null, "1e6", "10"), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6p", "Orbital 6P", new ExponentialEffect(player.quarkstage.producers, 1, 2, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimalNormal(obj.value) + "(*" + formatDecimalNormal(obj.increase) + ")"), new ExponentialCost(null, "1e6", "10"), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("7s", "Orbital 7S", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 1.1, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new ExponentialCost(null, "1e6", "10"), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5f", "Orbital 5F", new ExponentialEffect(player.quarkstage.electrify, 1, 1.1, EffectTypes.PrestigeMultiplicativeGain, null, (obj) => "Electron Gain *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 1) + ")"), new ExponentialCost(null, "1e6", "10"), player.electronstage.clouds.power, new AchievementRequirement("1nucleonize")));
