...
function setupbasicelectronupgradesstage2() {
  ...
  player.electronstage.upgrades.push(new Upgrade("eu15", "I need dem quarks", 100, new AchievementRequirement("1nucleonize"), new ExponentialEffect(player.quarkstage.producers, 1, 10, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimal(obj.value) + "(*" + formatDecimal(obj.increase) + ")"), new ExponentialCost(player.electronstage.electrons, "1e120", "1e10"), "upg", {tag : "e"}));
  player.electronstage.upgrades.push(new Upgrade("eu16", "I need the spin", 100, new AchievementRequirement("1nucleonize"), new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 7.5, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Spin Production *" + formatDecimal(obj.value) + "(*" + formatDecimal(obj.increase) + ")"), new ExponentialCost(player.electronstage.electrons, "1e150", "1e15"), "upg", {tag : "e"}));
  player.electronstage.upgrades.push(new Upgrade("eu17", "Electrons make the world go round", 100, new AchievementRequirement("1nucleonize"), new ExponentialEffect(player.quarkstage.electrify, 1, 5, EffectTypes.PrestigeMultiplicativeGain, null, (obj) => "Electron Gain *" + formatDecimal(obj.value) + "(*" + formatDecimal(obj.increase) + ")"), new ExponentialCost(player.electronstage.electrons, "1e250", "1e25"), "upg", {tag : "e"}));
