...
function setupbasicelectroncloud() {
  ...
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4p", "Orbital 4P", new ExponentialEffect(player.quarkstage.producers, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Producer Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("100multor")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5s", "Orbital 5S", new ExponentialEffect(player.quarkstage.upgrades, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Producers Upgrades Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("100multor")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4d", "Orbital 4D", new ExponentialEffect(player.electronstage.quarkspinproducers, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Spin Producers Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("100multor")));
  player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5p", "Orbital 5P", new ExponentialEffect(player.electronstage.quarkspinupgrades, 1, .99, EffectTypes.PriceScaling, null, (obj) => "Quark Spin Upgrades Cost Scaling *" + formatDecimalOverride(obj.value, 2) + "(*" + formatDecimalOverride(obj.increase, 2) + ")"), new CombinedCost([new ExponentialCost(null, "1e3", "1e1"), new HyperExponentialCost(null, "1e14", "1e1", "2")], ["10"]), player.electronstage.clouds.power, new AchievementRequirement("100multor")));
