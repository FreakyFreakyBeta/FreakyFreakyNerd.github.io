function setupbasicnucelonplit(){
    ...
    player.nucleonstage.split.gridinfo.piecegenerator = new PieceGenerator("splitpiecegen", 1, 1, new ExponentialCost(getcurrency("neutron"), "10", "1.1"), {"width": new HyperExponentialCost(getcurrency("neutrondust"), "10", "10", "3"),"height": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"effectmax": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"min0": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"max0": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"min1": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"max1": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"min2": new ExponentialCost(getcurrency("neutrondust"), "10", "10"),"max2": new ExponentialCost(getcurrency("neutrondust"), "10", "10")}, {"width": 10, "height":10}, [(level) => 1 + level * .25,(level) => 1 + level * .05,(level) => 1 + level * .01], [(level) => 1 + level * .5,(level) => 1 + level * .1,(level) => 1 + level * .02], "splitupg");
}
