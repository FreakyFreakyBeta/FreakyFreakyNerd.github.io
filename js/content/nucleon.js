...
function setupnucleonproducers() {
  ...
  player.nucleonstage.electronchargeproducers.push(new Producer("ecp2", "Charging Chamber 2", new ExponentialCost(player.nucleonstage.nucleons, 1e3, 10), new LinearProduction(player.nucleonstage.electronchargeproducers[0], 1, 0), new NumRequirement(player.nucleonstage.electronchargeproducers[0], 5), "chargep", null));
  player.nucleonstage.electronchargeproducers.push(new Producer("ecp3", "Charging Chamber 3", new ExponentialCost(player.nucleonstage.nucleons, 1e15, 10), new LinearProduction(player.nucleonstage.electronchargeproducers[1], 1, 0), new NumRequirement(player.nucleonstage.electronchargeproducers[1], 5), "chargep", null));
  player.nucleonstage.electronchargeproducers.push(new Producer("ecp4", "Charging Chamber 4", new ExponentialCost(player.nucleonstage.nucleons, 1e50, 10), new LinearProduction(player.nucleonstage.electronchargeproducers[2], 1, 0), new NumRequirement(player.nucleonstage.electronchargeproducers[2], 5), "chargep", null));
  player.nucleonstage.electronchargeproducers.push(new Producer("ecp5", "Chargin Chamber 5", new ExponentialCost(player.nucleonstage.nucleons, 1e100, 10), new LinearProduction(player.nucleonstage.electronchargeproducers[3], 1, 0), new NumRequirement(player.nucleonstage.electronchargeproducers[3], 5), "chargep", null));
  ...
  player.nucleonstage.gluonproducers.push(new Producer("gp5", "Gluon Producer 3", new ExponentialCost(player.nucleonstage.nucleons, 1e100, 10), new LinearProduction(player.nucleonstage.gluonproducers[3], 1, 0), new NumRequirement(player.nucleonstage.gluonproducers[3], 5), "gluonp", null));
}
