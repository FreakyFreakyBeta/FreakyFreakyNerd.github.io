...
function setupachievements() {
  ...
  nextbasicachievementcolumn();
  addbasicachievement(new Achievement("1000producers", "A lot of producers", new FunctionRequirement(() => totalproducerbought(player.quarkstage.producers).greaterThan(999), "1000 Quark Producers Bought"), new AchievementRequirement("10quarkgenone"), new FlavorEffect("Bragging Rights"), null, getbasictag(), 10));
  addbasicachievement(new Achievement("1e5producers", "A lot more producers", new FunctionRequirement(() => totalproducerbought(player.quarkstage.producers).greaterThanOrEqualTo(1e5), "1e5 Quark Producers Bought"), new AchievementRequirement("1000producers"), new FlavorEffect("Bragging Rights"), null, getbasictag(), 15));
  addbasicachievement(new Achievement("1e10producers", "This one helps", new FunctionRequirement(() => totalproducerbought(player.quarkstage.producers).greaterThanOrEqualTo(1e10), "1e10 Quark Producers Bought"), new AchievementRequirement("1e5producers"), new FlavorEffect("Bragging Rights"), null, getbasictag(), 25));
