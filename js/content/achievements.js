...
function setupachievements() {
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenone", achievementlabel(row, player.achievements.basic[row].length, "A little better, now at 10 Chargers"), [new NumRequirement(player.quarkstage.producers[0], 10)], null, [new UnlockLogEffect("Spinner Quark Producer"), new UnlockLogEffect("Quark Upgrade that boosts Charger")]));
  player.achievements.basic[row].push(new Achievement("100quarkgenone", achievementlabel(row, player.achievements.basic[row].length, "I need the powah!"), [new NumRequirement(player.quarkstage.producers[0], 100)], null, [new UnlockLogEffect("Acceleron Quark Boost")]));
  player.achievements.basic[row].push(new Achievement("1e3quarkgenone", achievementlabel(row, player.achievements.basic[row].length, "Wo! Calm down. ;)"), [new NumRequirement(player.quarkstage.producers[0], 1e3)], null, [new UnlockLogEffect("Charger Quark Producer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgentwo", achievementlabel(row, player.achievements.basic[row].length, "Whats better than 1 spinner? 10 Spinners!"), [new NumRequirement(player.quarkstage.producers[1], 10)], null, [new UnlockLogEffect("Flipper Quark Producer"), new UnlockLogEffect("Quark Upgrade that boosting Spinner")]));
  player.achievements.basic[row].push(new Achievement("100quarkgentwo", achievementlabel(row, player.achievements.basic[row].length, "Get in that spinning craze!"), [new NumRequirement(player.quarkstage.producers[1], 100)], null, [new UnlockLogEffect("Multor Quark Boost")]));
  player.achievements.basic[row].push(new Achievement("1e3quarkgentwo", achievementlabel(row, player.achievements.basic[row].length, "You spin me right round, right round!"), [new NumRequirement(player.quarkstage.producers[1], 1e3)], null, [new UnlockLogEffect("Spinner Quark Producer autobuyer.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenthree", achievementlabel(row, player.achievements.basic[row].length, "The business is growing, get 10 Flippers."), [new NumRequirement(player.quarkstage.producers[2], 10)], null, [new UnlockLogEffect("Charmer Quark Producer"), new UnlockLogEffect("Quark Upgrade that boosting Flipper")]));
  ...
  player.achievements.basic[row].push(new Achievement("1e3quarkgenthree", achievementlabel(row, player.achievements.basic[row].length, "Flip it and slap it!"), [new NumRequirement(player.quarkstage.producers[2], 1e3)], null, [new UnlockLogEffect("Flipper Quark Proucer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenfour", achievementlabel(row, player.achievements.basic[row].length, "So Many to charm, so little charmers."), [new NumRequirement(player.quarkstage.producers[3], 10)], null, [new UnlockLogEffect("Eightfold Way Quark Producer"), new UnlockLogEffect("Quark Upgrade boosting Charmer")]));
  ...
  player.achievements.basic[row].push(new Achievement("1e3quarkgenfour", achievementlabel(row, player.achievements.basic[row].length, "True loves kiss!"), [new NumRequirement(player.quarkstage.producers[3], 1e3)], null, [new UnlockLogEffect("Charm Quark Producer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenfive", achievementlabel(row, player.achievements.basic[row].length, "Twofold?"), [new NumRequirement(player.quarkstage.producers[4], 10)], null, [new UnlockLogEffect("George Quark Producer"), new UnlockLogEffect("Quark Upgrade boosting Eightfold Way")]));
  player.achievements.basic[row].push(new Achievement("100quarkgenfive", achievementlabel(row, player.achievements.basic[row].length, "The paper is the size of the milky way!"), [new NumRequirement(player.quarkstage.producers[4], 100)], null, [new UnlockLogEffect("Acceleration Boost Quark Boost")]));
  player.achievements.basic[row].push(new Achievement("1e3quarkgenfive", achievementlabel(row, player.achievements.basic[row].length, "Time to sloooow dooooowwwwwwwwn"), [new NumRequirement(player.quarkstage.producers[4], 1e3)], null, [new UnlockLogEffect("Eightfold Way Quark Procuer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgensix", achievementlabel(row, player.achievements.basic[row].length, "10 George's must get confusing."), [new NumRequirement(player.quarkstage.producers[5], 10)], null, [new UnlockLogEffect("Murray Quark Producer"), new UnlockLogEffect("Quark Upgrade boosting George")]));
  ...
  player.achievements.basic[row].push(new Achievement("1e3quarkgensix", achievementlabel(row, player.achievements.basic[row].length, "A college of Georges"), [new NumRequirement(player.quarkstage.producers[5], 1e3)], null, [new UnlockLogEffect("George Quark Producer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenseven", achievementlabel(row, player.achievements.basic[row].length, "A dozen Murrays."), [new NumRequirement(player.quarkstage.producers[6], 10)], null, [new UnlockLogEffect("Epoch Quark Producer"), new UnlockLogEffect("Quark Upgrade boosting Murray")]));
  ...
  player.achievements.basic[row].push(new Achievement("1e3quarkgenseven", achievementlabel(row, player.achievements.basic[row].length, "Should we mix the Murrays and Georges?"), [new NumRequirement(player.quarkstage.producers[6], 1e3)], null, [new UnlockLogEffect("Murray Quark Producer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgeneight", achievementlabel(row, player.achievements.basic[row].length, "Spoiler, Its a defining period of time."), [new NumRequirement(player.quarkstage.producers[7], 10)], null, [new UnlockLogEffect("Scattering Quark Producer"), new UnlockLogEffect("Quark Upgrade boosting Epoch")]));
  ...
  player.achievements.basic[row].push(new Achievement("1e3quarkgeneight", achievementlabel(row, player.achievements.basic[row].length, "Time should speed up and slow down."), [new NumRequirement(player.quarkstage.producers[7], 1e3)], null, [new UnlockLogEffect("Epoch Quark Producer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgennine", achievementlabel(row, player.achievements.basic[row].length, "Lets scatter some more."), [new NumRequirement(player.quarkstage.producers[8], 10)], null, [new UnlockLogEffect("Big Bang Quark Producer"), new UnlockLogEffect("Quark Upgrade boosting Scattering")]));
  player.achievements.basic[row].push(new Achievement("100quarkgennine", achievementlabel(row, player.achievements.basic[row].length, "Get some mirrors."), [new NumRequirement(player.quarkstage.producers[8], 100)], null, [new UnlockLogEffect("Accelerator Quark Boost")]));
  player.achievements.basic[row].push(new Achievement("1e3quarkgennine", achievementlabel(row, player.achievements.basic[row].length, "Lets try some color refraction."), [new NumRequirement(player.quarkstage.producers[8], 1e3)], null, [new UnlockLogEffect("Scattering Quark Producer autobuyer")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenten", achievementlabel(row, player.achievements.basic[row].length, "But, How?"), [new NumRequirement(player.quarkstage.producers[9], 10)], null, [new UnlockLogEffect("Quark Upgrade boosting Big Bang"), new UnlockLogEffect("Many more Quark Upgrades that have their own requirements to display"), new StaticEffect(player.quarkstage.producers, 2, EffectTypes.ProducerMultiplierProduction, null, () => "Quark Production x2")]));
  player.achievements.basic[row].push(new Achievement("100quarkgenten", achievementlabel(row, player.achievements.basic[row].length, "Ok, 100 time deaths of the universe"), [new NumRequirement(player.quarkstage.producers[9], 100)], null, [new UnlockLogEffect("Multiplication Boost Quark Producer")]));
  player.achievements.basic[row].push(new Achievement("1e3quarkgenten", achievementlabel(row, player.achievements.basic[row].length, "Time flies."), [new NumRequirement(player.quarkstage.producers[9], 1e3)], null, [new UnlockLogEffect("Big Banger Quark Producer autobuyer")]));
  ...
  player.achievements.basic.push([]);
  row = player.achievements.basic.length - 1;
  player.achievements.basic[row].push(new Achievement("electrifyunlock", achievementlabel(row, player.achievements.basic[row].length, "Electrify"), [new NumRequirement(player.quarkstage.quarks, "1e16")], null, [new UnlockLogEffect("Electrify!! Which is a prestige tier and opens up tons of new content, would recommend right away!")]));
  player.achievements.basic[row].push(new Achievement("challengeunlock", achievementlabel(row, player.achievements.basic[row].length, "Your getting mightly powerful"), [new NumRequirement(player.quarkstage.quarks, "1e16")], null, [new UnlockLogEffect("Challenges to test your all mighty power")]));
  player.achievements.basic[row].push(new Achievement("multronunlock", achievementlabel(row, player.achievements.basic[row].length, "Might as well unlock another upgrade."), [new NumRequirement(player.quarkstage.quarks, "1e35")], null, [new UnlockLogEffect("Multron Quark Boost")]));
  player.achievements.basic[row].push(new Achievement("quarkupgradesauto", achievementlabel(row, player.achievements.basic[row].length, "Unlocks automation for all upgrades in the Quark Boost tab."), [new NumRequirement(player.quarkstage.quarks, "1e60")], null, [new UnlockLogEffect("10? New Quark Boost autobuyers")]));
  player.achievements.basic[row].push(new Achievement("quarkupgradesunlock", achievementlabel(row, player.achievements.basic[row].length, "Unlocks two new upgrades in the Quark Boost tab."), [new NumRequirement(player.quarkstage.quarks, "1e100")], null, [new UnlockLogEffect("Acceleratron Quark Boost"), new UnlockLogEffect("Multiplier Quark Boost")]));
  player.achievements.basic[row].push(new Achievement("infinityquarks", achievementlabel(row, player.achievements.basic[row].length, "What infinity gives more automation, who could have known?"), [new NumRequirement(player.quarkstage.quarks, "1.8e308")], null, [new UnlockLogEffect("Even more automation, will greatly help when nucleonizing! (Recommended before nucleonizing for the first time)")]));
  ...
  player.achievements.basic.push([]);
  row = player.achievements.basic.length - 1;
  player.achievements.basic[row].push(new Achievement("1e24electrons", achievementlabel(row, player.achievements.basic[row].length, "A Reasonable Number"), [new NumRequirement(player.electronstage.electrons, "1e16")], null, [new UnlockLogEffect("Orbitals Mechanic"), new StaticEffect(player.quarkstage.electrify, 2, EffectTypes.PrestigeMultiplicativeGain, null, () => "Electron Gain *2")]));
  ...
  player.achievements.basic[row].push(new Achievement("25nucleonize", achievementlabel(row, player.achievements.basic[row].length, "Getting Up There"), [new FunctionRequirement(() => player.stats.prestigeamounts.nucleonize >= 25, "Nucleonize 25 Times")], null, [new UnlockLogEffect("Nucleon Split (New Mechanic)", new UnlockLogEffect("Nucleon Gain Formula Much Better"))]));
  player.achievements.basic[row].push(new Achievement("250nucleonize", achievementlabel(row, player.achievements.basic[row].length, "I want progress"), [new FunctionRequirement(() => player.stats.prestigeamounts.nucleonize >= 250, "Nucleonize 250 Times")], null, [new FlavorEffect("")]));
}
