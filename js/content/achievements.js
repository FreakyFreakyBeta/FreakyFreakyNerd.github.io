...
function setupachievements() {
  ...
  player.achievements.basic[row].push(new Achievement("25nucleonize", achievementlabel(row, player.achievements.basic[row].length, "Getting Up There"), [new FunctionRequirement(() => player.stats.prestigeamounts.nucleonize >= 25, "Nucleonize 25 Times")], null, [new UnlockLogEffect("Nucleon Split (New Mechanic)", new FlavorEffect("Nucleon Gain Formula Much Better"))]));
