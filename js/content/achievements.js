...
function setupachievements() {
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenone", achievementlabel(row, player.achievements.basic[row].length, "A little better, now at 10 Chargers"), [new NumRequirement(player.quarkstage.producers[0], 10)], null, [new FlavorEffect("Unlocks Spinner for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgentwo", achievementlabel(row, player.achievements.basic[row].length, "Whats better than 1 spinner? 10 Spinners!"), [new NumRequirement(player.quarkstage.producers[1], 10)], null, [new FlavorEffect("Unlocks Flipper for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenthree", achievementlabel(row, player.achievements.basic[row].length, "The business is growing, get 10 Flippers."), [new NumRequirement(player.quarkstage.producers[2], 10)], null, [new FlavorEffect("Unlocks Charmer for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenfour", achievementlabel(row, player.achievements.basic[row].length, "So Many to charm, so little charmers."), [new NumRequirement(player.quarkstage.producers[3], 10)], null, [new FlavorEffect("Unlocks Eightfold Way for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenfive", achievementlabel(row, player.achievements.basic[row].length, "Twofold?"), [new NumRequirement(player.quarkstage.producers[4], 10)], null, [new FlavorEffect("Unlocks George for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgensix", achievementlabel(row, player.achievements.basic[row].length, "10 George's must get confusing."), [new NumRequirement(player.quarkstage.producers[5], 10)], null, [new FlavorEffect("Unlocks Murray for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenseven", achievementlabel(row, player.achievements.basic[row].length, "A dozen Murrays."), [new NumRequirement(player.quarkstage.producers[6], 10)], null, [new FlavorEffect("Unlocks Epoch for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgeneight", achievementlabel(row, player.achievements.basic[row].length, "Spoiler, Its a defining period of time."), [new NumRequirement(player.quarkstage.producers[7], 10)], null, [new FlavorEffect("Unlocks Scattering for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgennine", achievementlabel(row, player.achievements.basic[row].length, "Lets scatter some more."), [new NumRequirement(player.quarkstage.producers[8], 10)], null, [new FlavorEffect("Unlocks Big Bang for purchase.")]));
  ...
  player.achievements.basic[row].push(new Achievement("10quarkgenten", achievementlabel(row, player.achievements.basic[row].length, "But, How?"), [new NumRequirement(player.quarkstage.producers[9], 10)], null, [new StaticEffect(player.quarkstage.producers, 2, EffectTypes.ProducerMultiplierProduction, null, () => "Quark Production x2")]));
